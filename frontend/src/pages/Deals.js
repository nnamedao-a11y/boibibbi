    ...
    <motion.div data-testid="deals-page" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 lg:mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-[#18181B] leading-tight" style={{ fontFamily: 'Mazzard, Mazzard H, Mazzard M, system-ui, sans-serif' }}>{t('dealsTitle')}</h1>
            <p className="text-[12px] text-[#71717A] mt-0.5">{t('salesPipeline')}</p>
          </div>
        </div>
