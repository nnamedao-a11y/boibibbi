        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-2xl font-bold text-[#18181B] leading-tight break-words" style={{ fontFamily: 'Mazzard, Mazzard H, Mazzard M, system-ui, sans-serif' }}>
                {t('vinEngineTitle')}
              </h1>
              <p className="text-[12px] text-[#71717A] mt-0.5 break-words">{t('vinEngineSubtitle')}</p>
            </div>
          </div>
