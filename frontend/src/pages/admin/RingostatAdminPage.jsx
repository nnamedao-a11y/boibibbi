    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <h1 className="text-2xl font-bold text-[#18181B] leading-tight">{t('ringostatOpsControl')}</h1>
          <p className="text-[12px] text-[#71717A] mt-0.5">{t('adm_call_management_webhook_managers_and_logic')}</p>
        </div>
      </div>
