...
async def customer360_invoices(customer_id: str):
...
async def customer360_orders(customer_id: str):
...
async def customer360_payments(customer_id: str):
...
async def customer360_finance_summary(customer_id: str):
